 ...
 * @file          main.h
 *
 * @brief         Header file for the main CAN Task on TM4C123GH6PM
 *
 * @date          4/9/2021
 *
...
/*****************************************************************************
                                Preprocessor Macros
*****************************************************************************/
/* Macro for Number of iterations in 1ms for while loop delay */
#define NUMBER_OF_ITERATIONS_PER_ONE_MILI_SECOND    762

/* Defines for GPIOB Module Bit location in RCGC2 */
#define GPIOB_MODULE_CLK_ENABLE     ((uint8)0x01)
#define GPIOB_MODULE_CLK_POS        ((uint8)0x01)

/* Defines for GPIOB CAN Pins */
#define CAN_RX_PB4_ENABLE           ((uint8)0x01)
#define CAN_TX_PB5_ENABLE           ((uint8)0x01)
#define CAN_PCTL_VAL                ((uint8)0x08)
#define CAN_DIGITAL_ENABLE          ((uint8)0x01)
